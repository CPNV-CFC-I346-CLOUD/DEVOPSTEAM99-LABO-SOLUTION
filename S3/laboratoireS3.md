...
* Créer la structure de fichiers utilisée pour faire mes tests.
...
```
[OUTPUT]
2025-02-23 09:22:35      17010 Airplane-Transponder.jpg
2025-02-23 09:09:10          0 fileToUpload.txt
2025-02-23 09:10:21          0 folderToUpload/bob.txt
2025-02-23 09:10:21          0 folderToUpload/script.sql
```
...
```bash
aws s3 rm s3://devopsteam99-i346/Airplane-Transponder.jpg ^
--profile devopsteam99-i346
```
...
Note : resynchronisation avec mes données locales pour rendre le test plus démonstratif.
